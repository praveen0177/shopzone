...
// serche bar  //
 ...
 // Open the payment form modal with product details
 
 function openPaymentForm(productName, productPrice) {
...
// Show the confirmation modal after payment
function showConfirmationModal() {
  closePaymentForm(); // Close the payment form modal first
